...
print("=" * 80)
print("API FEATURE VERIFICATION")
print("=" * 80)
...
print(f"   ✅ {len(webhooks)} webhook(s) in database")

# 4. Test Export
print("\n4. Testing multi-format export...")
test_findings = [
...
print(f"   ✅ SARIF export: {len(sarif_export)} characters")
